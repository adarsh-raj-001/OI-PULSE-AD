...
assert.equal(result.aggregates.callVolume, 900);
assert.equal(result.aggregates.putVolume, 600);
assert.equal(result.aggregates.callBidQuantity, 120);
assert.equal(result.aggregates.callAskQuantity, 30);
assert.equal(result.aggregates.callBidAskQuantityDifference, 90);
assert.equal(result.aggregates.putBidAskQuantityDifference, -80);
